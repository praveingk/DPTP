/*
 * This application is a simple DPTP (Data-plane Time-synchronization Protocol) Client.
 * It sends DPTP requests across the enabled ports, and synchronizes the nic and kernel clock.
 */
...
lcore_main(void)
{
  ...
  start_dptp(ptp_enabled_port_nb, tor_switch, mbuf_pool);
}
